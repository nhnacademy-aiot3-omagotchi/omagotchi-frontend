...
import site.omagotchi.frontend.learning.attendance.infrastructure.AttendanceHttpService;
...
@ImportHttpServices(
        ...
        types = {LearningHttpService.class, AttendanceHttpService.class, SensorHttpService.class}
)
