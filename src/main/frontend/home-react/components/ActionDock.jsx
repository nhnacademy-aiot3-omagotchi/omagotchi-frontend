...
const LegacyDockControls = React.memo(function LegacyDockControls({ attendanceVisible }) {
  return (
    <>
...
export function ActionDock({ aiOpen = false, onAiToggle = () => {}, attendanceVisible = false }) {
  return (
    <div className="home-action-dock" aria-label="홈 빠른 실행">
      ...
      <LegacyDockControls attendanceVisible={attendanceVisible} />
    </div>
  );
}
