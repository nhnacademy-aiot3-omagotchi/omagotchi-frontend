...
function normalizeContext(context = {}) {
  return {
    ...
    onRetry: typeof context.onRetry === "function" ? context.onRetry : undefined,
    onSaveSensor: typeof context.onSaveSensor === "function" ? context.onSaveSensor : undefined,
    onSaveThresholds: typeof context.onSaveThresholds === "function" ? context.onSaveThresholds : undefined,
    onAlertQueryChange: typeof context.onAlertQueryChange === "function" ? context.onAlertQueryChange : undefined
  };
}
