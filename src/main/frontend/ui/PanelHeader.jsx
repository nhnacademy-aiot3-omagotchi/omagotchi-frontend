 ...
 *   home-overlay-header  (오버레이)   home-ai-panel-heading (AI)   quick-ui-panel-header (BGM·출석)
...
export function PanelHeader({
  ...
  return (
    <header className={`ui-panel-header${className ? ` ${className}` : ""}`}>
      {/* 아이콘은 장식이다. 제목이 같은 뜻을 전달하므로 보조기기에서 감춘다. */}
      <span className="ui-panel-header-icon" aria-hidden="true">
