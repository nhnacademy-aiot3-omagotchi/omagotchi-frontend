...
class PageBusinessExceptionHandlerTest {
    ...
    void logsServerFailureAndRendersServerErrorView() throws Exception {
        ...
        verify(errorEventLogger).log(
                any(BusinessException.class),
                eq(CommonErrorCode.SERVICE_UNAVAILABLE),
    ...
    void handlesLearningDownstreamServerFailureAsHtml() throws Exception {
