...
아래 두 항목은 이후 작업에서 완료했다. 경과는 [후속 경과](#후속-경과-2026-09-04-기준) 참고.
...
- **전 구간 왕복은 운영에서 확인됐다.** Gemini·Ollama 모두 실제 응답을 받았다. Ollama는
  응답이 느려 읽기 타임아웃에 더 자주 걸린다.
...
- 이후 별도 작업에서 AI 채팅 전용 읽기 타임아웃(30초)과 답변 평문 렌더링이 추가됐다.
